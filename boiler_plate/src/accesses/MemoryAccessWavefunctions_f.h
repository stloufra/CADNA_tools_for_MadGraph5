...
#ifndef MemoryAccessWavefunctions_f_H
#define MemoryAccessWavefunctions_f_H 1
...
#endif
{
  ...
  class MemoryAccessWavefunctionsBase_f //_AOSOAv1
  {
  public:
  ...
  private:
    ...
    friend class MemoryAccessHelper<MemoryAccessWavefunctionsBase_f>;
    friend class KernelAccessHelper<MemoryAccessWavefunctionsBase_f, true>;
    friend class KernelAccessHelper<MemoryAccessWavefunctionsBase_f, false>;
  ...
  class MemoryAccessWavefunctions_f : public MemoryAccessWavefunctionsBase_f
  {
  public:

    // Locate an event record (output) in a memory buffer (input) from the given event number (input)
    // [Signature (non-const) ===> fptype_f* ieventAccessRecord( fptype_f* buffer, const int ievt ) <===]
    static constexpr auto ieventAccessRecord = MemoryAccessHelper<MemoryAccessWavefunctionsBase_f>::ieventAccessRecord;

    // Locate an event record (output) in a memory buffer (input) from the given event number (input)
    // [Signature (const) ===> const fptype_f* ieventAccessRecordConst( const fptype_f* buffer, const int ievt ) <===]
    static constexpr auto ieventAccessRecordConst = MemoryAccessHelper<MemoryAccessWavefunctionsBase_f>::ieventAccessRecordConst;

    // Locate a field (output) of an event record (input) from the given field indexes (input)
    // [Signature (non-const) ===> fptype_f& decodeRecord( fptype_f* buffer, const int iw6, const int ix2 ) <===]
    static constexpr auto decodeRecordIw6Ix2 = MemoryAccessHelper<MemoryAccessWavefunctionsBase_f>::decodeRecord;

    // Locate a field (output) of an event record (input) from the given field indexes (input)
    // [Signature (const) ===> const fptype_f& decodeRecordConst( const fptype_f* buffer, const int iw6, const int ix2 ) <===]
    static constexpr auto decodeRecordIw6Ix2Const =
      MemoryAccessHelper<MemoryAccessWavefunctionsBase_f>::template decodeRecordConst<int, int>;

    // Locate a field (output) in a memory buffer (input) from the given event number (input) and the given field indexes (input)
    // [Signature (non-const) ===> fptype_f& ieventAccessIw6Ix2( fptype_f* buffer, const ievt, const int iw6, const int ix2 ) <===]
    static constexpr auto ieventAccessIw6Ix2 =
      MemoryAccessHelper<MemoryAccessWavefunctionsBase_f>::template ieventAccessField<int, int>;

    // Locate a field (output) in a memory buffer (input) from the given event number (input) and the given field indexes (input)
    // [Signature (const) ===> const fptype_f& ieventAccessIw6Ix2Const( const fptype_f* buffer, const ievt, const int iw6, const int ix2 ) <===]
    static constexpr auto ieventAccessIw6Ix2Const =
      MemoryAccessHelper<MemoryAccessWavefunctionsBase_f>::template ieventAccessFieldConst<int, int>;
  };
  ...
  class KernelAccessWavefunctions_f
  {
  public:
    ...
    // [Signature (non-const) ===> fptype_f& kernelAccessIw6Ix2( fptype_f* buffer, const int iw6, const int ix2 ) <===]
    static constexpr auto kernelAccessIw6Ix2 =
      KernelAccessHelper<MemoryAccessWavefunctionsBase_f, onDevice>::template kernelAccessField<int, int>;

    // Locate a field (output) in a memory buffer (input) from a kernel event-indexing mechanism (internal) and the given field indexes (input)
    // [Signature (const) ===> const fptype_f& kernelAccessIw6Ix2Const( const fptype_f* buffer, const int iw6, const int ix2 ) <===]
    static constexpr auto kernelAccessIw6Ix2Const =
      KernelAccessHelper<MemoryAccessWavefunctionsBase_f, onDevice>::template kernelAccessFieldConst<int, int>;
  ...
  typedef KernelAccessWavefunctions_f<false> HostAccessWavefunctions_f;
  typedef KernelAccessWavefunctions_f<true> DeviceAccessWavefunctions_f;
