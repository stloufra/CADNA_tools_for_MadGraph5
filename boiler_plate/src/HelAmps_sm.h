...
#define ALWAYS_INLINE
           ...
           const int ipar) // input: particle# out of npar
    {
        ...
        if (fmass_FT != 0.)
        {
            ...
            const FT_ixxxxx pp = fpmin(pvec0, fpsqrt<FT_ixxxxx>(pvec1 * pvec1 + pvec2 * pvec2 + pvec3 * pvec3));
#else
            ...
            const int ip = (1 + nh) / 2;
            // NB: same as in Fortran pp==0, differs from Fortran pp>0, which is (3+nh)/2 because omega(2) has indexes 1,2
            const int im = (1 - nh) / 2;
            // NB: same as in Fortran pp==0, differs from Fortran pp>0, which is (3-nh)/2 because omega(2) has indexes 1,2
#ifndef MGONGPU_CPPSIMD
            if (pp == 0.)
            ...
            else
            {
                ...
                const FT_ixxxxx pp3 = fpmax(pp + pvec3, 0.);
                const cxsmpl<FT_ixxxxx> chi[2] = {
                    cxmake<FT_ixxxxx>(fpsqrt<FT_ixxxxx>(pp3 * (FT_ixxxxx)0.5 / pp), 0.),
            ...
            const cxsmpl<FT_ixxxxx>_v chi[2] = {
                cxmake<FT_ixxxxx>(fpsqrt<FT_ixxxxx>(chi0r2), 0), // hack: dummy[ieppV] is not used if pp[ieppV]==0
                cxternary((pp3 == 0.),
                          cxmake<FT_ixxxxx>(-nh, 0),
                          cxmake<FT_ixxxxx>((FT_ixxxxx)nh * pvec1, pvec2) / fpsqrt<FT_ixxxxx>(2. * ppDENOM * pp3DENOM))
            }; // hack: dummy[ieppV] is not used if pp[ieppV]==0
        ...
        else
        {
            ...
            volatile FT_ixxxxx sqp0p3DENOM = fpternary(sqp0p3 != 0, (FT_ixxxxx)sqp0p3, 1.);
            // hack: dummy sqp0p3DENOM[ieppV]=1 if sqp0p3[ieppV]==0
            cxsmpl<FT_ixxxxx> chi[2] = {
                cxmake<FT_ixxxxx>((FT_ixxxxx_v)sqp0p3, 0.),
                cxternary(sqp0p3 == 0,
                          cxmake<FT_ixxxxx>(-(FT_ixxxxx)nhel * fpsqrt<FT_ixxxxx>(2. * pvec0), 0.),
                          cxmake<FT_ixxxxx>((FT_ixxxxx)nh * pvec1, pvec2) / (const FT_ixxxxx_v)sqp0p3DENOM)
            }; // hack: dummy[ieppV] is not used if sqp0p3[ieppV]==0
#else
            const FT_ixxxxx sqp0p3 = fpternary((pvec1 == 0. and pvec2 == 0. and pvec3 < 0.),
                                               FT_ixxxxx{0},
                                               fpsqrt<FT_ixxxxx>(fpmax(pvec0 + pvec3, 0.)) * (FT_ixxxxx)nsf);
            const cxsmpl<FT_ixxxxx> chi[2] = {
                cxmake<FT_ixxxxx>(sqp0p3, 0.),
                (sqp0p3 == 0.
                     ? cxmake<FT_ixxxxx>(-(FT_ixxxxx)nhel * fpsqrt<FT_ixxxxx>(2. * pvec0), 0.)
                     : cxmake<FT_ixxxxx>((FT_ixxxxx)nh * pvec1, pvec2) / sqp0p3)
            };
#endif
            if (nh == 1)
            {
           ...
           const int ipar) // input: particle# out of npar
    {
        ...
        if (vmass != 0.)
        {
            ...
            const cxsmpl<FT_vxxxxx>_v vcB_5 = cxmake<FT_vxxxxx>(hel0 * pvec3 * emp + hel * pt / ppDENOM * sqh, 0);
            // hack: dummy[ieppV] is not used if pp[ieppV]==0
            // Branch B1: pp != 0. and pt != 0.
            volatile FT_vxxxxx_v ptDENOM = fpternary(pt != 0, pt, 1.); // hack: ptDENOM[ieppV]=1 if pt[ieppV]==0
            const FT_vxxxxx_v pzpt = pvec3 / (ppDENOM * ptDENOM) * sqh * hel;
            // hack: dummy[ieppV] is not used if pp[ieppV]==0
            const cxsmpl<FT_vxxxxx>_v vcB1_3 = cxmake<FT_vxxxxx>(hel0 * pvec1 * emp - pvec1 * pzpt, -(FT_vxxxxx)nsvahl * pvec2 / ptDENOM * sqh);
            // hack: dummy[ieppV] is not used if pt[ieppV]==0
            const cxsmpl<FT_vxxxxx>_v vcB1_4 = cxmake<FT_vxxxxx>(hel0 * pvec2 * emp - pvec2 * pzpt, (FT_vxxxxx)nsvahl * pvec1 / ptDENOM * sqh);
            // hack: dummy[ieppV] is not used if pt[ieppV]==0
            // Branch B2: pp != 0. and pt == 0.
            const cxsmpl<FT_vxxxxx> vcB2_3 = cxmake<FT_vxxxxx>(-hel * sqh, 0.);
            const cxsmpl<FT_vxxxxx>_v vcB2_4 = cxmake<FT_vxxxxx>(0., (FT_vxxxxx)nsvahl * fpternary((pvec3 < 0), -sqh, sqh));
            // AV: removed an abs here
        ...
        else
        {
            ...
            const cxsmpl<FT_vxxxxx>_v vcA_3 = cxmake<FT_vxxxxx>(-pvec1 * pzpt, -(FT_vxxxxx)nsv * pvec2 / ptDENOM * sqh);
            // hack: dummy[ieppV] is not used if pt[ieppV]==0
            const cxsmpl<FT_vxxxxx>_v vcA_4 = cxmake<FT_vxxxxx>(-pvec2 * pzpt, (FT_vxxxxx)nsv * pvec1 / ptDENOM * sqh);
            // hack: dummy[ieppV] is not used if pt[ieppV]==0
            // Branch B: pt == 0.
            const cxsmpl<FT_vxxxxx> vcB_3 = cxmake<FT_vxxxxx>(-(FT_vxxxxx)hel * sqh, 0);
            const cxsmpl<FT_vxxxxx>_v vcB_4 = cxmake<FT_vxxxxx>(0, (FT_vxxxxx)nsv * fpternary((pvec3 < 0), -sqh, sqh));
            // AV: removed an abs here
            // Choose between the results from branch A and branch B
           ...
           const int ipar) // input: particle# out of npar
    {
        ...
        if (fmass_FT != 0.)
        {
            ...
            else
            {
                ...
                const cxsmpl<FT_oxxxxx> chi[2] = {
                    cxmake<FT_oxxxxx>(fpsqrt<FT_oxxxxx>(pp3 * (FT_oxxxxx)0.5 / pp), 0.),
                    ((pp3 == 0.)
            ...
            const cxsmpl<FT_oxxxxx>_v chi[2] = {
                cxmake<FT_oxxxxx>(fpsqrt<FT_oxxxxx>(chi0r2), 0.), // hack: dummy[ieppV] is not used if pp[ieppV]==0
                (cxternary((pp3 == 0.),
                           cxmake<FT_oxxxxx>(-nh, 0.),
                           cxmake<FT_oxxxxx>((FT_oxxxxx)nh * pvec1, -pvec2) / fpsqrt<FT_oxxxxx>(2. * ppDENOM * pp3DENOM)))
            }; // hack: dummy[ieppV] is not used if pp[ieppV]==0
        ...
        else
        {
            ...
            volatile FT_oxxxxx_v sqp0p3DENOM = fpternary(sqp0p3 != 0, (FT_oxxxxx)sqp0p3, 1.);
            // hack: sqp0p3DENOM[ieppV]=1 if sqp0p3[ieppV]==0
            const cxsmpl<FT_oxxxxx>_v chi[2] = {
                cxmake<FT_oxxxxx>((FT_oxxxxx_v)sqp0p3, 0.),
                cxternary((sqp0p3 == 0.),
                          cxmake<FT_oxxxxx>(-nhel, 0.) * fpsqrt<FT_oxxxxx>(2. * pvec0),
                          cxmake<FT_oxxxxx>((FT_oxxxxx)nh * pvec1, -pvec2) / (const FT_oxxxxx)sqp0p3DENOM)
            }; // hack: dummy[ieppV] is not used if sqp0p3[ieppV]==0
#else
          ...
          fptype allvertexes[] )
  {
    ...
    cxtype_sv* vertex = A_ACCESS::kernelAccess( allvertexes );
	 	 ...
	 	 const cxsmpl<FT_VVV1_0> COUP = static_cast<cxsmpl<FT_VVV1_0>>(COUP_);
		for(int i = 0; i < 6; ++i)
		{
    ...
    const cxsmpl<FT_VVV1_0> cI = cxmake<FT_VVV1_0>( 0., 1. );
    const FT_VVV1_0 P1[4] = { static_cast<FT_VVV1_0>(+cxreal( V1[0] )), static_cast<FT_VVV1_0>(+cxreal( V1[1] )), static_cast<FT_VVV1_0>(+cximag( V1[1] )), static_cast<FT_VVV1_0>(+cximag( V1[0] )) };
    const FT_VVV1_0 P2[4] = { static_cast<FT_VVV1_0>(+cxreal( V2[0] )), static_cast<FT_VVV1_0>(+cxreal( V2[1] )), static_cast<FT_VVV1_0>(+cximag( V2[1] )), static_cast<FT_VVV1_0>(+cximag( V2[0] )) };
    const FT_VVV1_0 P3[4] = { static_cast<FT_VVV1_0>(+cxreal( V3[0] )), static_cast<FT_VVV1_0>(+cxreal( V3[1] )), static_cast<FT_VVV1_0>(+cximag( V3[1] )), static_cast<FT_VVV1_0>(+cximag( V3[0] )) };
    ...
    ( *vertex ) =static_cast<cxsmpl<fptype>>( static_cast<FT_VVV1_0>(Ccoeff) * COUP * ( TMP1 * ( -cI * TMP0 + cI * TMP2 ) + ( TMP3 * ( +cI * TMP4 - cI * TMP5 ) + TMP6 * ( -cI * TMP7 + cI * TMP8 ) ) ));
    mgDebug( 1, __FUNCTION__ );
    return;
  }
             ...
             fptype allV1[])
    {
        ...
        const cxsmpl<FT_VVV1P0_1> TMP0 = (V3[2] * P1[0] - V3[3] * P1[1] - V3[4] * P1[2] - V3[5] * P1[3]);
        const cxsmpl<FT_VVV1P0_1> TMP2 = (V3[2] * P2[0] - V3[3] * P2[1] - V3[4] * P2[2] - V3[5] * P2[3]);
        const cxsmpl<FT_VVV1P0_1> TMP4 = (P1[0] * V2[2] - P1[1] * V2[3] - P1[2] * V2[4] - P1[3] * V2[5]);
        const cxsmpl<FT_VVV1P0_1> TMP5 = (V2[2] * P3[0] - V2[3] * P3[1] - V2[4] * P3[2] - V2[5] * P3[3]);
        const cxsmpl<FT_VVV1P0_1> TMP6 = (V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5]);
        const cxsmpl<FT_VVV1P0_1> denom = static_cast<FT_VVV1P0_1>(Ccoeff) * COUP / ((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] * P1[3]) -
            static_cast<FT_VVV1P0_1>(M1) * (static_cast<FT_VVV1P0_1>(M1) - cI * static_cast<FT_VVV1P0_1>(W1)));
        V1[2] =static_cast<cxsmpl<fptype>>( denom * (TMP6 * (-cI * P2[0] + cI * P3[0]) + (V2[2] * (-cI * TMP0 + cI * TMP2) + V3[2] * (+cI * TMP4 -
            cI * TMP5))));
        V1[3] =static_cast<cxsmpl<fptype>>( denom * (TMP6 * (-cI * P2[1] + cI * P3[1]) + (V2[3] * (-cI * TMP0 + cI * TMP2) + V3[3] * (+cI * TMP4 -
            cI * TMP5))));
        V1[4] =static_cast<cxsmpl<fptype>>( denom * (TMP6 * (-cI * P2[2] + cI * P3[2]) + (V2[4] * (-cI * TMP0 + cI * TMP2) + V3[4] * (+cI * TMP4 -
            cI * TMP5))));
        V1[5] =static_cast<cxsmpl<fptype>>( denom * (TMP6 * (-cI * P2[3] + cI * P3[3]) + (V2[5] * (-cI * TMP0 + cI * TMP2) + V3[5] * (+cI * TMP4 -
            cI * TMP5))));
        mgDebug(1, __FUNCTION__);
        return;
    }
           ...
           fptype allvertexes[])
    {
        ...
        const cxtype_sv COUP_ = C_ACCESS::kernelAccessConst(allCOUP);
        cxtype_sv* vertex = A_ACCESS::kernelAccess(allvertexes);
	 	 cxsmpl<FT_FFV1_0> F1[6];
	 	 cxsmpl<FT_FFV1_0> F2[6];
	 	 cxsmpl<FT_FFV1_0> V3[6];
	 	 const cxsmpl<FT_FFV1_0> COUP = static_cast<cxsmpl<FT_FFV1_0>>(COUP_);
		for(int i = 0; i < 6; ++i)
		{
	 	 F1[i] = static_cast<cxsmpl<FT_FFV1_0>>(F1_[i]);
	 	 F2[i] = static_cast<cxsmpl<FT_FFV1_0>>(F2_[i]);
	 	 V3[i] = static_cast<cxsmpl<FT_FFV1_0>>(V3_[i]);
		}
        const cxsmpl<FT_FFV1_0> cI = cxmake<FT_FFV1_0>(0., 1.);
        const cxsmpl<FT_FFV1_0> TMP9 = (F1[2] * (F2[4] * (V3[2] + V3[5]) + F2[5] * (V3[3] + cI * V3[4])) + (F1[3] * (F2[4] * (V3
            [3] - cI * V3[4]) + F2[5] * (V3[2] - V3[5])) + (F1[4] * (F2[2] * (V3[2] - V3[5]) - F2[3] * (V3[3] + cI * V3[
            4])) + F1[5] * (F2[2] * (-V3[3] + cI * V3[4]) + F2[3] * (V3[2] + V3[5])))));
        (*vertex) =static_cast<cxsmpl<fptype>>( static_cast<FT_FFV1_0>(Ccoeff) * COUP * -cI * TMP9);
        mgDebug(1, __FUNCTION__);
        return;
    }
           ...
           fptype allF1[])
    {
        ...
        const cxsmpl<FT_FFV1_1> denom = static_cast<FT_FFV1_1>(Ccoeff) * COUP / ((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] * P1[3]) -
            static_cast<FT_FFV1_1>(M1) * (static_cast<FT_FFV1_1>(M1) - cI * static_cast<FT_FFV1_1>(W1)));
        F1[2] =static_cast<cxsmpl<fptype>>( denom * cI * (F2[2] * (P1[0] * (-V3[2] + V3[5]) + (P1[1] * (V3[3] - cI * V3[4]) + (P1[2] * (+cI * V3[3]
            + V3[4]) + P1[3] * (-V3[2] + V3[5])))) + (F2[3] * (P1[0] * (V3[3] + cI * V3[4]) + (P1[1] * (-one) * (V3[2] +
            V3[5]) + (P1[2] * (-one) * (+cI * (V3[2] + V3[5])) + P1[3] * (V3[3] + cI * V3[4])))) + static_cast<FT_FFV1_1>(M1) * (F2[4] * (V3[2]
            + V3[5]) + F2[5] * (V3[3] + cI * V3[4])))));
        F1[3] =static_cast<cxsmpl<fptype>>( denom * (-cI) * (F2[2] * (P1[0] * (-V3[3] + cI * V3[4]) + (P1[1] * (V3[2] - V3[5]) + (P1[2] * (-cI * V3[
            2] + cI * V3[5]) + P1[3] * (V3[3] - cI * V3[4])))) + (F2[3] * (P1[0] * (V3[2] + V3[5]) + (P1[1] * (-one) * (
            V3[3] + cI * V3[4]) + (P1[2] * (+cI * V3[3] - V3[4]) - P1[3] * (V3[2] + V3[5])))) + static_cast<FT_FFV1_1>(M1) * (F2[4] * (-V3[3] +
            cI * V3[4]) + F2[5] * (-V3[2] + V3[5])))));
        F1[4] =static_cast<cxsmpl<fptype>>( denom * (-cI) * (F2[4] * (P1[0] * (V3[2] + V3[5]) + (P1[1] * (-V3[3] + cI * V3[4]) + (P1[2] * (-one) * (
            +cI * V3[3] + V3[4]) - P1[3] * (V3[2] + V3[5])))) + (F2[5] * (P1[0] * (V3[3] + cI * V3[4]) + (P1[1] * (-V3[
            2] + V3[5]) + (P1[2] * (-cI * V3[2] + cI * V3[5]) - P1[3] * (V3[3] + cI * V3[4])))) + static_cast<FT_FFV1_1>(M1) * (F2[2] * (-V3[2]
            + V3[5]) + F2[3] * (V3[3] + cI * V3[4])))));
        F1[5] =static_cast<cxsmpl<fptype>>( denom * cI * (F2[4] * (P1[0] * (-V3[3] + cI * V3[4]) + (P1[1] * (V3[2] + V3[5]) + (P1[2] * (-one) * (+cI
            * (V3[2] + V3[5])) + P1[3] * (-V3[3] + cI * V3[4])))) + (F2[5] * (P1[0] * (-V3[2] + V3[5]) + (P1[1] * (V3[3]
            + cI * V3[4]) + (P1[2] * (-cI * V3[3] + V3[4]) + P1[3] * (-V3[2] + V3[5])))) + static_cast<FT_FFV1_1>(M1) * (F2[2] * (-V3[3] + cI *
            V3[4]) + F2[3] * (V3[2] + V3[5])))));
        mgDebug(1, __FUNCTION__);
        return;
    }
           ...
           fptype allF2[])
    {
        ...
        const cxsmpl<FT_FFV1_2> denom = static_cast<FT_FFV1_2>(Ccoeff) * COUP / ((P2[0] * P2[0]) - (P2[1] * P2[1]) - (P2[2] * P2[2]) - (P2[3] * P2[3]) -
            static_cast<FT_FFV1_2>(M2) * (static_cast<FT_FFV1_2>(M2) - cI * static_cast<FT_FFV1_2>(W2)));
        F2[2] =static_cast<cxsmpl<fptype>>( denom * cI * (F1[2] * (P2[0] * (V3[2] + V3[5]) + (P2[1] * (-one) * (V3[3] + cI * V3[4]) + (P2[2] * (+cI
            * V3[3] - V3[4]) - P2[3] * (V3[2] + V3[5])))) + (F1[3] * (P2[0] * (V3[3] - cI * V3[4]) + (P2[1] * (-V3[2] +
            V3[5]) + (P2[2] * (+cI * V3[2] - cI * V3[5]) + P2[3] * (-V3[3] + cI * V3[4])))) + static_cast<FT_FFV1_2>(M2) * (F1[4] * (V3[2] - V3[
            5]) + F1[5] * (-V3[3] + cI * V3[4])))));
        F2[3] =static_cast<cxsmpl<fptype>>( denom * (-cI) * (F1[2] * (P2[0] * (-one) * (V3[3] + cI * V3[4]) + (P2[1] * (V3[2] + V3[5]) + (P2[2] * (+
            cI * (V3[2] + V3[5])) - P2[3] * (V3[3] + cI * V3[4])))) + (F1[3] * (P2[0] * (-V3[2] + V3[5]) + (P2[1] * (V3[
            3] - cI * V3[4]) + (P2[2] * (+cI * V3[3] + V3[4]) + P2[3] * (-V3[2] + V3[5])))) + static_cast<FT_FFV1_2>(M2) * (F1[4] * (V3[3] + cI
            * V3[4]) - F1[5] * (V3[2] + V3[5])))));
        F2[4] =static_cast<cxsmpl<fptype>>( denom * (-cI) * (F1[4] * (P2[0] * (-V3[2] + V3[5]) + (P2[1] * (V3[3] + cI * V3[4]) + (P2[2] * (-cI * V3[
            3] + V3[4]) + P2[3] * (-V3[2] + V3[5])))) + (F1[5] * (P2[0] * (V3[3] - cI * V3[4]) + (P2[1] * (-one) * (V3[
            2] + V3[5]) + (P2[2] * (+cI * (V3[2] + V3[5])) + P2[3] * (V3[3] - cI * V3[4])))) + static_cast<FT_FFV1_2>(M2) * (F1[2] * (-one) * (
            V3[2] + V3[5]) + F1[3] * (-V3[3] + cI * V3[4])))));
        F2[5] =static_cast<cxsmpl<fptype>>( denom * cI * (F1[4] * (P2[0] * (-one) * (V3[3] + cI * V3[4]) + (P2[1] * (V3[2] - V3[5]) + (P2[2] * (+cI
            * V3[2] - cI * V3[5]) + P2[3] * (V3[3] + cI * V3[4])))) + (F1[5] * (P2[0] * (V3[2] + V3[5]) + (P2[1] * (-V3[
            3] + cI * V3[4]) + (P2[2] * (-one) * (+cI * V3[3] + V3[4]) - P2[3] * (V3[2] + V3[5])))) + static_cast<FT_FFV1_2>(M2) * (F1[2] * (V3[
            3] + cI * V3[4]) + F1[3] * (V3[2] - V3[5])))));
        mgDebug(1, __FUNCTION__);
        return;
    }
             ...
             fptype allV3[])
    {
        ...
        const cxsmpl<FT_FFV1P0_3> denom = static_cast<FT_FFV1P0_3>(Ccoeff) * COUP / ((P3[0] * P3[0]) - (P3[1] * P3[1]) - (P3[2] * P3[2]) - (P3[3] * P3[3]) -
            static_cast<FT_FFV1P0_3>(M3) * (static_cast<FT_FFV1P0_3>(M3) - cI * static_cast<FT_FFV1P0_3>(W3)));
        V3[2] =static_cast<cxsmpl<fptype>>( denom * (-cI) * (F1[2] * F2[4] + F1[3] * F2[5] + F1[4] * F2[2] + F1[5] * F2[3]));
        V3[3] =static_cast<cxsmpl<fptype>>( denom * (-cI) * (-F1[2] * F2[5] - F1[3] * F2[4] + F1[4] * F2[3] + F1[5] * F2[2]));
        V3[4] =static_cast<cxsmpl<fptype>>( denom * (-cI) * (-cI * (F1[2] * F2[5] + F1[5] * F2[2]) + cI * (F1[3] * F2[4] + F1[4] * F2[3])));
        V3[5] =static_cast<cxsmpl<fptype>>( denom * (-cI) * (-F1[2] * F2[4] - F1[5] * F2[3] + F1[3] * F2[5] + F1[4] * F2[2]));
        mgDebug(1, __FUNCTION__);
        return;
    }
            ...
            fptype allvertexes[])
    {
        ...
        const cxtype_sv* V2_ = W_ACCESS::kernelAccessConst(allV2);
        const cxtype_sv* V3_ = W_ACCESS::kernelAccessConst(allV3);
        const cxtype_sv* V4_ = W_ACCESS::kernelAccessConst(allV4);
        const cxtype_sv COUP_ = C_ACCESS::kernelAccessConst(allCOUP);
        cxtype_sv* vertex = A_ACCESS::kernelAccess(allvertexes);
	 	 cxsmpl<FT_VVVV1_0> V1[6];
	 	 cxsmpl<FT_VVVV1_0> V2[6];
	 	 cxsmpl<FT_VVVV1_0> V3[6];
	 	 cxsmpl<FT_VVVV1_0> V4[6];
	 	 const cxsmpl<FT_VVVV1_0> COUP = static_cast<cxsmpl<FT_VVVV1_0>>(COUP_);
		for(int i = 0; i < 6; ++i)
		{
	 	 V1[i] = static_cast<cxsmpl<FT_VVVV1_0>>(V1_[i]);
	 	 V2[i] = static_cast<cxsmpl<FT_VVVV1_0>>(V2_[i]);
	 	 V3[i] = static_cast<cxsmpl<FT_VVVV1_0>>(V3_[i]);
	 	 V4[i] = static_cast<cxsmpl<FT_VVVV1_0>>(V4_[i]);
		}
        const cxsmpl<FT_VVVV1_0> cI = cxmake<FT_VVVV1_0>(0., 1.);
        const cxsmpl<FT_VVVV1_0> TMP10 = (V1[2] * V4[2] - V1[3] * V4[3] - V1[4] * V4[4] - V1[5] * V4[5]);
        const cxsmpl<FT_VVVV1_0> TMP11 = (V2[2] * V4[2] - V2[3] * V4[3] - V2[4] * V4[4] - V2[5] * V4[5]);
        const cxsmpl<FT_VVVV1_0> TMP3 = (V3[2] * V1[2] - V3[3] * V1[3] - V3[4] * V1[4] - V3[5] * V1[5]);
        const cxsmpl<FT_VVVV1_0> TMP6 = (V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5]);
        (*vertex) =static_cast<cxsmpl<fptype>>( static_cast<FT_VVVV1_0>(Ccoeff) * COUP * (-cI * (TMP6 * TMP10) + cI * (TMP3 * TMP11)));
        mgDebug(1, __FUNCTION__);
        return;
    }
              ...
              fptype allV1[])
    {
        ...
        const cxtype_sv COUP_ = C_ACCESS::kernelAccessConst(allCOUP);
        cxtype_sv* V1 = W_ACCESS::kernelAccess(allV1);
	 	 cxsmpl<FT_VVVV1P0_1> V2[6];
	 	 cxsmpl<FT_VVVV1P0_1> V3[6];
	 	 cxsmpl<FT_VVVV1P0_1> V4[6];
	 	 const cxsmpl<FT_VVVV1P0_1> COUP = static_cast<cxsmpl<FT_VVVV1P0_1>>(COUP_);
		for(int i = 0; i < 6; ++i)
		{
	 	 V2[i] = static_cast<cxsmpl<FT_VVVV1P0_1>>(V2_[i]);
	 	 V3[i] = static_cast<cxsmpl<FT_VVVV1P0_1>>(V3_[i]);
	 	 V4[i] = static_cast<cxsmpl<FT_VVVV1P0_1>>(V4_[i]);
		}
        const cxsmpl<FT_VVVV1P0_1> cI = cxmake<FT_VVVV1P0_1>(0., 1.);
        V1[0] =static_cast<cxsmpl<fptype>>( +V2[0] + V3[0] + V4[0]);
        V1[1] =static_cast<cxsmpl<fptype>>( +V2[1] + V3[1] + V4[1]);
        const FT_VVVV1P0_1 P1[4] = {static_cast<FT_VVVV1P0_1>(-cxreal(V1[0])), static_cast<FT_VVVV1P0_1>(-cxreal(V1[1])), static_cast<FT_VVVV1P0_1>(-cximag(V1[1])), static_cast<FT_VVVV1P0_1>(-cximag(V1[0]))};
        const cxsmpl<FT_VVVV1P0_1> TMP11 = (V2[2] * V4[2] - V2[3] * V4[3] - V2[4] * V4[4] - V2[5] * V4[5]);
        const cxsmpl<FT_VVVV1P0_1> TMP6 = (V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5]);
        const cxsmpl<FT_VVVV1P0_1> denom = static_cast<FT_VVVV1P0_1>(Ccoeff) * COUP / ((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] * P1[3]) -
            static_cast<FT_VVVV1P0_1>(M1) * (static_cast<FT_VVVV1P0_1>(M1) - cI * static_cast<FT_VVVV1P0_1>(W1)));
        V1[2] =static_cast<cxsmpl<fptype>>( denom * (-cI * (TMP6 * V4[2]) + cI * (V3[2] * TMP11)));
        V1[3] =static_cast<cxsmpl<fptype>>( denom * (-cI * (TMP6 * V4[3]) + cI * (V3[3] * TMP11)));
        V1[4] =static_cast<cxsmpl<fptype>>( denom * (-cI * (TMP6 * V4[4]) + cI * (V3[4] * TMP11)));
        V1[5] =static_cast<cxsmpl<fptype>>( denom * (-cI * (TMP6 * V4[5]) + cI * (V3[5] * TMP11)));
        mgDebug(1, __FUNCTION__);
        return;
    }
            ...
            fptype allvertexes[])
    {
        ...
        const cxtype_sv COUP_ = C_ACCESS::kernelAccessConst(allCOUP);
        cxtype_sv* vertex = A_ACCESS::kernelAccess(allvertexes);
	 	 cxsmpl<FT_VVVV3_0> V1[6];
	 	 cxsmpl<FT_VVVV3_0> V2[6];
	 	 cxsmpl<FT_VVVV3_0> V3[6];
	 	 cxsmpl<FT_VVVV3_0> V4[6];
	 	 const cxsmpl<FT_VVVV3_0> COUP = static_cast<cxsmpl<FT_VVVV3_0>>(COUP_);
		for(int i = 0; i < 6; ++i)
		{
	 	 V1[i] = static_cast<cxsmpl<FT_VVVV3_0>>(V1_[i]);
	 	 V2[i] = static_cast<cxsmpl<FT_VVVV3_0>>(V2_[i]);
	 	 V3[i] = static_cast<cxsmpl<FT_VVVV3_0>>(V3_[i]);
	 	 V4[i] = static_cast<cxsmpl<FT_VVVV3_0>>(V4_[i]);
		}
        const cxsmpl<FT_VVVV3_0> cI = cxmake<FT_VVVV3_0>(0., 1.);
        const cxsmpl<FT_VVVV3_0> TMP1 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]);
        const cxsmpl<FT_VVVV3_0> TMP10 = (V1[2] * V4[2] - V1[3] * V4[3] - V1[4] * V4[4] - V1[5] * V4[5]);
        const cxsmpl<FT_VVVV3_0> TMP12 = (V3[2] * V4[2] - V3[3] * V4[3] - V3[4] * V4[4] - V3[5] * V4[5]);
        const cxsmpl<FT_VVVV3_0> TMP6 = (V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5]);
        (*vertex) =static_cast<cxsmpl<fptype>>( static_cast<FT_VVVV3_0>(Ccoeff) * COUP * (-cI * (TMP6 * TMP10) + cI * (TMP1 * TMP12)));
        mgDebug(1, __FUNCTION__);
        return;
    }
              ...
              fptype allV1[])
    {
        ...
        const cxtype_sv COUP_ = C_ACCESS::kernelAccessConst(allCOUP);
        cxtype_sv* V1 = W_ACCESS::kernelAccess(allV1);
	 	 cxsmpl<FT_VVVV3P0_1> V2[6];
	 	 cxsmpl<FT_VVVV3P0_1> V3[6];
	 	 cxsmpl<FT_VVVV3P0_1> V4[6];
	 	 const cxsmpl<FT_VVVV3P0_1> COUP = static_cast<cxsmpl<FT_VVVV3P0_1>>(COUP_);
		for(int i = 0; i < 6; ++i)
		{
	 	 V2[i] = static_cast<cxsmpl<FT_VVVV3P0_1>>(V2_[i]);
	 	 V3[i] = static_cast<cxsmpl<FT_VVVV3P0_1>>(V3_[i]);
	 	 V4[i] = static_cast<cxsmpl<FT_VVVV3P0_1>>(V4_[i]);
		}
        const cxsmpl<FT_VVVV3P0_1> cI = cxmake<FT_VVVV3P0_1>(0., 1.);
        V1[0] =static_cast<cxsmpl<fptype>>( +V2[0] + V3[0] + V4[0]);
        V1[1] =static_cast<cxsmpl<fptype>>( +V2[1] + V3[1] + V4[1]);
        const FT_VVVV3P0_1 P1[4] = {static_cast<FT_VVVV3P0_1>(-cxreal(V1[0])), static_cast<FT_VVVV3P0_1>(-cxreal(V1[1])), static_cast<FT_VVVV3P0_1>(-cximag(V1[1])), static_cast<FT_VVVV3P0_1>(-cximag(V1[0]))};
        const cxsmpl<FT_VVVV3P0_1> TMP12 = (V3[2] * V4[2] - V3[3] * V4[3] - V3[4] * V4[4] - V3[5] * V4[5]);
        const cxsmpl<FT_VVVV3P0_1> TMP6 = (V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5]);
        const cxsmpl<FT_VVVV3P0_1> denom = static_cast<FT_VVVV3P0_1>(Ccoeff) * COUP / ((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] * P1[3]) -
            static_cast<FT_VVVV3P0_1>(M1) * (static_cast<FT_VVVV3P0_1>(M1) - cI * static_cast<FT_VVVV3P0_1>(W1)));
        V1[2] =static_cast<cxsmpl<fptype>>( denom * (-cI * (TMP6 * V4[2]) + cI * (V2[2] * TMP12)));
        V1[3] =static_cast<cxsmpl<fptype>>( denom * (-cI * (TMP6 * V4[3]) + cI * (V2[3] * TMP12)));
        V1[4] =static_cast<cxsmpl<fptype>>( denom * (-cI * (TMP6 * V4[4]) + cI * (V2[4] * TMP12)));
        V1[5] =static_cast<cxsmpl<fptype>>( denom * (-cI * (TMP6 * V4[5]) + cI * (V2[5] * TMP12)));
        mgDebug(1, __FUNCTION__);
        return;
    }
            ...
            fptype allvertexes[])
    {
        ...
        const cxtype_sv COUP_ = C_ACCESS::kernelAccessConst(allCOUP);
        cxtype_sv* vertex = A_ACCESS::kernelAccess(allvertexes);
	 	 cxsmpl<FT_VVVV4_0> V1[6];
	 	 cxsmpl<FT_VVVV4_0> V2[6];
	 	 cxsmpl<FT_VVVV4_0> V3[6];
	 	 cxsmpl<FT_VVVV4_0> V4[6];
	 	 const cxsmpl<FT_VVVV4_0> COUP = static_cast<cxsmpl<FT_VVVV4_0>>(COUP_);
		for(int i = 0; i < 6; ++i)
		{
	 	 V1[i] = static_cast<cxsmpl<FT_VVVV4_0>>(V1_[i]);
	 	 V2[i] = static_cast<cxsmpl<FT_VVVV4_0>>(V2_[i]);
	 	 V3[i] = static_cast<cxsmpl<FT_VVVV4_0>>(V3_[i]);
	 	 V4[i] = static_cast<cxsmpl<FT_VVVV4_0>>(V4_[i]);
		}
        const cxsmpl<FT_VVVV4_0> cI = cxmake<FT_VVVV4_0>(0., 1.);
        const cxsmpl<FT_VVVV4_0> TMP1 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]);
        const cxsmpl<FT_VVVV4_0> TMP11 = (V2[2] * V4[2] - V2[3] * V4[3] - V2[4] * V4[4] - V2[5] * V4[5]);
        const cxsmpl<FT_VVVV4_0> TMP12 = (V3[2] * V4[2] - V3[3] * V4[3] - V3[4] * V4[4] - V3[5] * V4[5]);
        const cxsmpl<FT_VVVV4_0> TMP3 = (V3[2] * V1[2] - V3[3] * V1[3] - V3[4] * V1[4] - V3[5] * V1[5]);
        (*vertex) =static_cast<cxsmpl<fptype>>( static_cast<FT_VVVV4_0>(Ccoeff) * COUP * (-cI * (TMP3 * TMP11) + cI * (TMP1 * TMP12)));
        mgDebug(1, __FUNCTION__);
        return;
    }
              ...
              fptype allV1[])
    {
        ...
        const cxtype_sv COUP_ = C_ACCESS::kernelAccessConst(allCOUP);
        cxtype_sv* V1 = W_ACCESS::kernelAccess(allV1);
	 	 cxsmpl<FT_VVVV4P0_1> V2[6];
	 	 cxsmpl<FT_VVVV4P0_1> V3[6];
	 	 cxsmpl<FT_VVVV4P0_1> V4[6];
	 	 const cxsmpl<FT_VVVV4P0_1> COUP = static_cast<cxsmpl<FT_VVVV4P0_1>>(COUP_);
		for(int i = 0; i < 6; ++i)
		{
	 	 V2[i] = static_cast<cxsmpl<FT_VVVV4P0_1>>(V2_[i]);
	 	 V3[i] = static_cast<cxsmpl<FT_VVVV4P0_1>>(V3_[i]);
	 	 V4[i] = static_cast<cxsmpl<FT_VVVV4P0_1>>(V4_[i]);
		}
        const cxsmpl<FT_VVVV4P0_1> cI = cxmake<FT_VVVV4P0_1>(0., 1.);
        V1[0] =static_cast<cxsmpl<fptype>>( +V2[0] + V3[0] + V4[0]);
        V1[1] =static_cast<cxsmpl<fptype>>( +V2[1] + V3[1] + V4[1]);
        const FT_VVVV4P0_1 P1[4] = {static_cast<FT_VVVV4P0_1>(-cxreal(V1[0])), static_cast<FT_VVVV4P0_1>(-cxreal(V1[1])), static_cast<FT_VVVV4P0_1>(-cximag(V1[1])), static_cast<FT_VVVV4P0_1>(-cximag(V1[0]))};
        const cxsmpl<FT_VVVV4P0_1> TMP11 = (V2[2] * V4[2] - V2[3] * V4[3] - V2[4] * V4[4] - V2[5] * V4[5]);
        const cxsmpl<FT_VVVV4P0_1> TMP12 = (V3[2] * V4[2] - V3[3] * V4[3] - V3[4] * V4[4] - V3[5] * V4[5]);
        const cxsmpl<FT_VVVV4P0_1> denom = static_cast<FT_VVVV4P0_1>(Ccoeff) * COUP / ((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] * P1[3]) -
            static_cast<FT_VVVV4P0_1>(M1) * (static_cast<FT_VVVV4P0_1>(M1) - cI * static_cast<FT_VVVV4P0_1>(W1)));
        V1[2] =static_cast<cxsmpl<fptype>>( denom * (-cI * (V3[2] * TMP11) + cI * (V2[2] * TMP12)));
        V1[3] =static_cast<cxsmpl<fptype>>( denom * (-cI * (V3[3] * TMP11) + cI * (V2[3] * TMP12)));
        V1[4] =static_cast<cxsmpl<fptype>>( denom * (-cI * (V3[4] * TMP11) + cI * (V2[4] * TMP12)));
        V1[5] =static_cast<cxsmpl<fptype>>( denom * (-cI * (V3[5] * TMP11) + cI * (V2[5] * TMP12)));
        mgDebug(1, __FUNCTION__);
        return;
    }
