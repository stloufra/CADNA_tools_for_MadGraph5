...
typedef BufferBase<fptype_f> BufferCouplings_f;
constexpr size_t sizePerEventCouplings_f = MemoryBuffers::ndcoup * MemoryBuffers::nx2;
typedef HostBuffer<fptype_f, sizePerEventCouplings_f, HostBufferALIGNED> HostBufferCouplings_f;

typedef BufferBase<fptype_d> BufferCouplings_d;
constexpr size_t sizePerEventCouplings_d = MemoryBuffers::ndcoup * MemoryBuffers::nx2;
typedef HostBuffer<fptype_d, sizePerEventCouplings_d, HostBufferALIGNED> HostBufferCouplings_d;
//----
...
typedef BufferBase<fptype_d> BufferMomenta_d;
constexpr size_t sizePerEventMomenta_d = MemoryBuffers::np4 * MemoryBuffers::npar;
typedef HostBuffer<fptype_d, sizePerEventMomenta_d, HostBufferALIGNED> HostBufferMomenta_d;

typedef BufferBase<fptype_f> BufferMomenta_f;
constexpr size_t sizePerEventMomenta_f = MemoryBuffers::np4 * MemoryBuffers::npar;
typedef HostBuffer<fptype_f, sizePerEventMomenta_f, HostBufferALIGNED> HostBufferMomenta_f;
...
typedef BufferBase<fptype_d> BufferMatrixElements_d;
constexpr size_t sizePerEventMatrixElements_d = 1;
typedef HostBuffer<fptype_d, sizePerEventMatrixElements_d, HostBufferALIGNED> HostBufferMatrixElements_d;

typedef BufferBase<fptype_f> BufferMatrixElements_f;
constexpr size_t sizePerEventMatrixElements_f = 1;
typedef HostBuffer<fptype_f, sizePerEventMatrixElements_f, HostBufferALIGNED> HostBufferMatrixElements_f;
...
typedef BufferBase<fptype_f> BufferWavefunctions_f;
constexpr size_t sizePerEventWavefunctions_f = MemoryBuffers::nw6 * MemoryBuffers::nx2;
typedef HostBuffer<fptype_f, sizePerEventWavefunctions_f, HostBufferALIGNED> HostBufferWavefunctions_f;

typedef BufferBase<fptype_d> BufferWavefunctions_d;
constexpr size_t sizePerEventWavefunctions_d = MemoryBuffers::nw6 * MemoryBuffers::nx2;
typedef HostBuffer<fptype_d, sizePerEventWavefunctions_d, HostBufferALIGNED> HostBufferWavefunctions_d;
